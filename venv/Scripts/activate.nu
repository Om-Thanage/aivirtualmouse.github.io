...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\SST\PycharmProjects\pythonProject\mouse\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\SST\PycharmProjects\pythonProject\mouse\venv\Scripts\deactivate.nu'
